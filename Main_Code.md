...
cotm_lvl_2_CR_05 = ['Ape', 'Black Bear', 'Warhorse', 'Giant Goat', ]
...
cotm_lvl_8_CR_1 = ['Brown Bear', 'Dire Wolf', 'Giant Eagle', 'Giant Hyena', 'Giant Octopus', 'Giant Spider', 'Giant Toad', 'Giant Vulture', 'Lion', 'Tiger']
...
Giant_Fire_Beetle = '''Giant Fire Beetle
Small beast, unaligned
...
Giant_Sea_Horse = '''Giant Sea Horse
Large beast, unaligned
...
Giant_Constrictor_Snake = '''Giant Constricor Snake
...
Sabre_Toothed_Tiger = '''Large beast, unaligned
...
all_beasts = cotm_lvl_18_CR_0 + cotm_lvl_18_CR_0125 + cotm_lvl_18_CR_025 + cotm_lvl_18_CR_05 + cotm_lvl_18_CR_1 + cotm_lvl_18_CR_2 + cotm_lvl_18_CR_3 + cotm_lvl_18_CR_4 + cotm_lvl_18_CR_5 + cotm_lvl_18_CR_6

all_standard_beasts = lvl_8_CR_0 + lvl_8_CR_0125 + lvl_8_CR_025 + lvl_8_CR_05 + lvl_8_CR_1
### 84 beasts in all, 64 in all_standard


def explore(): ###FIX BROKEN 'WHILE' LOOP### 
...
#prints which beasts are suitable for your subclass and level
        if subclass == 'n':
            ...
            if lvl == 1:
                ...
                print('You can be a beast up to CR 1/4, as long as it has no flying or swim speeds. Here are your options:')
                print('CR 0 - '+', '.join(lvl_2_CR_0))
                print('CR 1/8 -'+', '.join(lvl_2_CR_0125))
                print('CR 1/4 - '+', '.join(lvl_2_CR_025))
            elif lvl in range(4,8):
                print('You can be a beast up to CR 1/2, as long as it has no flying speed. Here are your options:')
                print('CR 0 - '+', '.join(lvl_4_CR_0))
                print('CR 1/8 -'+', '.join(lvl_4_CR_0125))
                print('CR 1/4 - '+', '.join(lvl_4_CR_025))
                print('CR 1/2 - '+', '.join(lvl_4_CR_05))
            elif lvl in range(4,21):
                print('You can be any beast up to CR 1. Here are your options:')
                print('CR 0 - '+', '.join(lvl_8_CR_0))
            ...
            if lvl == 1:
                ...
                print('You can be a beast up to CR 1, as long as it has no flying or swim speeds. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_2_CR_0))
                ...
                print('You can be a beast up to CR 1, as long as it has no flying speed. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_4_CR_0))
                ...
                print('You can be a beast up to CR 2, as long as it has no flying speed. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_6_CR_0))
                ...
                print('You can be any beast up to CR 2. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_8_CR_0))
                ...
                print('You can be any beast up to CR 3. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_9_CR_0))
                ...
                print('You can be any beast up to CR 4. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_12_CR_0))
                ...
                print('You can be any beast up to CR 5. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_15_CR_0))
                ...
                print('You can be any beast up to CR 6. Here are your options:')
                print('CR 0 - '+', '.join(cotm_lvl_18_CR_0))
        ...
        if lvl in range(2,21):
          stats = input('If you would like to know more about one of these beasts, enter it here: ')
          if stats == 'Baboon':
            print(Baboon)
          elif stats == 'Riding Horse':
              print(Riding_Horse) 
          elif stats == 'Mammoth':
              print(Mammoth) ###PLACEHOLDER until I write out EVERY GODDAMN BEAST
        restart = input('Would you like to keep exploring? (y/n) ')
        if restart == 'y':
            count +=1
        elif restart == 'n':
            return 
...
choice = input("Would you like to explore your wildshape options based on your level, or choose one now? Please enter 'explore' or 'choose' ")
if choice == 'explore':
    explore()
    input()
elif choice == 'choose':
